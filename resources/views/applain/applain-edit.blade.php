                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="post" class="needs-validation" novalidate=""
                            action="{{ route('admin.applain.update', $applain) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <select class="form-control select2 @error('opd_id') is-invalid @enderror"
                                        ...
                                        @forelse ($opds as $opd)
                                            <option value="{{ $opd['id'] }}"
                                                {{ $applain->opd_id == $opd['id'] ? 'selected' : '' }}>
                                                {{ $opd['nama'] }}
                                            </option>
                                        @empty
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <input type="text" class="form-control @error('nama_app') is-invalid @enderror"
                                        name="nama_app" value="{{ old('nama_app', $applain->nama_app) }}" required
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <textarea class="form-control @error('fungsi_app') is-invalid @enderror" name="fungsi_app" required
                                        autocomplete="fungsi_app" placeholder="{{ __('Fungsi Aplikasi') }}" style="height: 200px;resize: vertical">{{ old('fungsi_app', $applain->fungsi_app) }}</textarea>
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <input type="text" class="form-control @error('url') is-invalid @enderror"
                                        name="url" value="{{ old('url', $applain->url) }}" autocomplete="url"
                                        placeholder="{{ __('Url') }}">
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <input type="text" class="form-control @error('repositori') is-invalid @enderror"
                                        name="repositori" value="{{ old('repositori', $applain->repositori) }}"
                                    ...
                                    <select class="form-control select2 @error('layananapp_id') is-invalid @enderror"
                                        ...
                                        @forelse ($layananapps as $layananapp)
                                            <option value="{{ $layananapp->id }}"
                                                {{ $applain->layananapp_id == $layananapp->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-md-2 col-12">
                                    ...
                                    <select class="form-control select2 @error('jaringan_intra') is-invalid @enderror"
                                        ...
                                        <option value="1" {{ $applain->jaringan_intra == '1' ? 'selected' : '' }}>
                                            Internet</option>
                                        <option value="2" {{ $applain->jaringan_intra == '2' ? 'selected' : '' }}>
                                            Intranet</option>
                                    </select>
                                ...
                                <div class="form-group col-md-2 col-12">
                                    ...
                                    <select class="form-control select2 @error('status') is-invalid @enderror"
                                        ...
                                        {{-- <option value="">-</option> --}}
                                        <option value="1"{{ $applain->status == '1' ? 'selected' : '' }}>Aktif
                                        </option>
                                        <option value="0"{{ $applain->status == '0' ? 'selected' : '' }}>Tidak
                                            Aktif
                                        </option>
                                    </select>
                                    @error('status')
                                ...
                                <div id="alasan_non_aktif" class="form-group col-md-8 col-12" style="display: none">
                                    ...
                                    <textarea class="form-control @error('alasan_nonaktif') is-invalid @enderror" name="alasan_nonaktif"
                                        ...
                                        style="height: 200px;resize: vertical">{{ old('alasan_nonaktif', $applain->alasan_nonaktif) }}</textarea>
                                    ...
                                    <select class="form-control select2 @error('katpengguna_id') is-invalid @enderror"
                                        ...
                                        @forelse ($katpenggunas as $katpengguna)
                                            <option value="{{ $katpengguna->id }}"
                                                {{ $applain->katpengguna_id == $katpengguna->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control select2 @error('katserver_id') is-invalid @enderror"
                                        ...
                                        @forelse ($katservers as $katserver)
                                            <option value="{{ $katserver->id }}"
                                                {{ $applain->katserver_id == $katserver->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control select2 @error('katapp_id') is-invalid @enderror"
                                        ...
                                        @forelse ($katapps as $katapp)
                                            <option value="{{ $katapp->id }}"
                                                {{ $applain->katapp_id == $katapp->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    @if ($applain->dasar_hukum != '')
                                        <div class="mb-0 d-block">
                                            <a href="{{ asset(Storage::url($applain->dasar_hukum)) }}" target="_blank">
                                ...
                                <div class="form-group col-md-2 col-12">
                                    ...
                                    <select class="form-control select2 @error('aset_takberwujud') is-invalid @enderror"
                                        ...
                                        <option value="">-</option>
                                        <option value="0" {{ $applain->aset_takberwujud == '0' ? 'selected' : '' }}>
                                            Tidak</option>
                                        <option value="1" {{ $applain->aset_takberwujud == '1' ? 'selected' : '' }}>
                                            Ya
                                        </option>
                                    </select>
                            ...
                            <div class="card-footer text-left">
                                <a href="{{ route('admin.applain.index') }}""
