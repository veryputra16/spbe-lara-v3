                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="post" class="needs-validation" novalidate=""
                            action="{{ route('admin.keamanan.store', $application->id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" name="menerapkan_manajemen_katasandi"
                                                ...
                                                {{ old('menerapkan_manajemen_katasandi') ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" name="menerapkan_metode_hashing"
                                                ...
                                                {{ old('menerapkan_metode_hashing') ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                            <span
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" name="menerapkan_enkripsi_data"
                                                ...
                                                value="1"
                                                class="custom-switch-input"{{ old('menerapkan_enkripsi_data') ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                            <span
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" name="menerapkan_captcha_login"
                                                ...
                                                value="1" class="custom-switch-input"
                                                {{ old('menerapkan_captcha_login') ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                            <span
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" name="menerapkan_token_api" id="menerapkan_token_api"
                                                ...
                                                class="custom-switch-input"
                                                {{ old('menerapkan_token_api') ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                            <span
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" name="menerapkan_manajemen_sesi"
                                                ...
                                                value="1" class="custom-switch-input"
                                                {{ old('menerapkan_manajemen_sesi') ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                            <span
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" name="notif_user_login_bersama"
                                                ...
                                                value="1" class="custom-switch-input"
                                                {{ old('notif_user_login_bersama') ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                            <span
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" name="menerapkan_fitur_log" id="menerapkan_fitur_log"
                                                ...
                                                class="custom-switch-input"
                                                {{ old('menerapkan_fitur_log') ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                            <span
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" name="menerapkan_size_file" id="menerapkan_size_file"
                                                ...
                                                class="custom-switch-input"
                                                {{ old('menerapkan_size_file') ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                            <span
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" name="pernah_mengalami_serangan_cyber"
                                                ...
                                                class="custom-switch-input"
                                                {{ old('pernah_mengalami_serangan_cyber') ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                            <span
                                ...
                                <div class="form-group col-md-4 col-12">
                                    ...
                                    <select
                                        ...
                                        name="pernah_audit_keamanan" id="pernah_audit_keamanan" required
                                        autocomplete="pernah_audit_keamanan">
                                        {{-- <option value="">-</option> --}}
                                        <option value="belum"
                                            {{ old('pernah_audit_keamanan') == 'belum' ? 'selected' : '' }}>
                                            Belum
                                        </option>
                                        <option value="pernah"
                                            {{ old('pernah_audit_keamanan') == 'pernah' ? 'selected' : '' }}>
                                            Pernah
                                        </option>
                                    </select>
                                ...
                                <div id="siapa_melakukan_audit_keamanan_group" class="form-group col-md-4 col-12"
                                    style="display: none">
                                    ...
                                    <select
                                        ...
                                        name="siapa_melakukan_audit_keamanan" id="siapa_melakukan_audit_keamanan"
                                        autocomplete="siapa_melakukan_audit_keamanan">
                                        {{-- <option value="">-</option> --}}
                                        {{-- <option value="belum-dilaksanakan-audit"
                                            {{ old('siapa_melakukan_audit_keamanan') == 'belum-dilaksanakan-audit' ? 'selected' : '' }}>
                                            Belum Dilaksanakan Audit
                                        </option> --}}
                                        <option value="mandiri"
                                            {{ old('siapa_melakukan_audit_keamanan') == 'mandiri' ? 'selected' : '' }}>
                                            Mandiri
                                        </option>
                                        <option value="dinas-kominfos"
                                            {{ old('siapa_melakukan_audit_keamanan') == 'dinas-kominfos' ? 'selected' : '' }}>
                                            Dinas Kominfos
                                        </option>
                                        <option value="pihak-lainnya"
                                            {{ old('siapa_melakukan_audit_keamanan') == 'pihak-lainnya' ? 'selected' : '' }}>
                                            Pihak Lainnya
                                        </option>
                                    </select>
                                ...
                                <div id="bukti_dukung_audit_keamanan_group" class="form-group col-md-8 col-12"
                                    style="display: none">
    ...
    <script>
        $(document).ready(function() {
            function toggleAuditFields() {
                if ($('#pernah_audit_keamanan').val() === 'pernah') {
                    $('#siapa_melakukan_audit_keamanan_group').show();
                    $('#bukti_dukung_audit_keamanan').show();
                } else {
                    $('#siapa_melakukan_audit_keamanan_group').hide();
                    $('#bukti_dukung_audit_keamanan').hide();
                }
            }

            $('#pernah_audit_keamanan').change(toggleAuditFields);
            toggleAuditFields(); // Panggil saat halaman pertama kali dimuat
        });
    </script>
@endpush
