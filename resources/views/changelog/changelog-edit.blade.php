                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="post" class="needs-validation" novalidate=""
                            action="{{ route('admin.changelog.update', $changelog) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <input type="text" class="form-control @error('caption') is-invalid @enderror"
                                        name="caption" value="{{ old('caption', $changelog->caption) }}"
                                        autocomplete="caption" placeholder="{{ __('Caption') }}">
                                    @error('caption')
                                ...
                                <div class="form-group col-md-5 col-12">
                                    ...
                                    <input type="text" class="form-control @error('versi') is-invalid @enderror"
                                        name="versi" value="{{ old('versi', $changelog->versi) }}" autocomplete="versi"
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <textarea class="form-control @error('desc') is-invalid @enderror" name="desc" autocomplete="desc"
                                        placeholder="{{ __('Deskripsi') }}" style="height: 150px;resize: vertical">{{ old('desc', $changelog->desc) }}</textarea>
                                    @error('desc')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
