            ...
            <div class="row mt-sm-4">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="{{ route('system.subdomain.create') }}" class="btn btn-primary mb-3"><i
                                    ...
                                    <tbody>
                                        @foreach ($subdomains as $subdomain)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('system.subdomain.edit', $subdomain->id) }}"
                                                        class="btn btn-light btn-sm" title="Edit"><i
                                                            class="fas fa-edit"></i></a>
                                                    <form action="{{ route('system.subdomain.destroy', $subdomain->id) }}"
