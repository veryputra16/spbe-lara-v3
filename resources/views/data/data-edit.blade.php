                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="post" class="needs-validation" novalidate=""
                            action="{{ route('admin.data.update', ['application' => $application->id, 'data' => $data]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        name="siapa_produsen_data"
                                        value="{{ old('siapa_produsen_data', $data->siapa_produsen_data) }}"
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('siapa_pengguna_data_yg_dihasilkan_sistem', $data->siapa_pengguna_data_yg_dihasilkan_sistem) }}"
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <select
                                        ...
                                        <option value="tidak-ada"
                                            {{ old('data_sistem_menggunakan_kode_referensi', $data->data_sistem_menggunakan_kode_referensi) == 'tidak-ada' ? 'selected' : '' }}>
                                            Tidak Ada
                                        </option>
                                        <option value="ada"
                                            {{ old('data_sistem_menggunakan_kode_referensi', $data->data_sistem_menggunakan_kode_referensi) == 'ada' ? 'selected' : '' }}>
                                            Ada
                                        </option>
                                    </select>
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <select
                                        ...
                                        <option value="">-</option>
                                        <option value="tidak-ada"
                                            {{ old('app_memiliki_kebijakan_privasi_terkait_data', $data->app_memiliki_kebijakan_privasi_terkait_data) == 'tidak-ada' ? 'selected' : '' }}>
                                            Tidak Ada
                                        </option>
                                        <option value="ada"
                                            {{ old('app_memiliki_kebijakan_privasi_terkait_data', $data->app_memiliki_kebijakan_privasi_terkait_data) == 'ada' ? 'selected' : '' }}>
                                            Ada
                                        </option>
                                    </select>
                                ...
                                <div class="form-group col-md-4 col-12">
                                    ...
                                    <select
                                        ...
                                        <option value="tidak-pernah-backup"
                                            {{ old('siapa_melakukan_backup', $data->siapa_melakukan_backup) == 'tidak-pernah-backup' ? 'selected' : '' }}>
                                            Tidak Pernah Backup
                                        </option>
                                        <option value="mandiri"
                                            {{ old('siapa_melakukan_backup', $data->siapa_melakukan_backup) == 'mandiri' ? 'selected' : '' }}>
                                            Mandiri
                                        </option>
                                        <option value="pihak-ketiga"
                                            {{ old('siapa_melakukan_backup', $data->siapa_melakukan_backup) == 'pihak-ketiga' ? 'selected' : '' }}>
                                            Pihak Ketiga
                                        </option>
                                    </select>
                                ...
                                <div class="form-group col-md-3 col-12">
                                    ...
                                    <select class="form-control select2 @error('periode_backup') is-invalid @enderror"
                                        ...
                                        <option value="">-</option>
                                        <option value="tidak-ada"
                                            {{ old('periode_backup', $data->periode_backup) == 'tidak-ada' ? 'selected' : '' }}>
                                            Tidak ada
                                        </option>
                                        <option value="harian"
                                            {{ old('periode_backup', $data->periode_backup) == 'harian' ? 'selected' : '' }}>
                                            Harian
                                        </option>
                                        <option value="mingguan"
                                            {{ old('periode_backup', $data->periode_backup) == 'mingguan' ? 'selected' : '' }}>
                                            Mingguan
                                        </option>
                                        <option value="bulanan"
                                            {{ old('periode_backup', $data->periode_backup) == 'bulanan' ? 'selected' : '' }}>
                                            Bulanan
                                        </option>
                                        <option value="semesteran"
                                            {{ old('periode_backup', $data->periode_backup) == 'semesteran' ? 'selected' : '' }}>
                                            Semesteran
                                        </option>
                                        <option value="tahunan"
                                            {{ old('periode_backup', $data->periode_backup) == 'tahunan' ? 'selected' : '' }}>
                                            Tahunan
                                        </option>
                                    </select>
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <select
                                        ...
                                        <option value="">-</option>
                                        <option value="tidak-ada"
                                            {{ old('lokasi_penyimpanan_backup', $data->lokasi_penyimpanan_backup) == 'tidak-ada' ? 'selected' : '' }}>
                                            Tidak ada
                                        </option>
                                        <option value="eksternal"
                                            {{ old('lokasi_penyimpanan_backup', $data->lokasi_penyimpanan_backup) == 'eksternal' ? 'selected' : '' }}>
                                            Penyimpanan eksternal (Harddisk/Flashdisk)
                                        </option>
                                        <option value="server-lain"
                                            {{ old('lokasi_penyimpanan_backup', $data->lokasi_penyimpanan_backup) == 'server-lain' ? 'selected' : '' }}>
                                            Server lain
                                        </option>
                                    </select>
