                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="post" class="needs-validation" novalidate=""
                            action="{{ route('admin.sdmteknic.update', ['application' => $application->id, 'sdmteknic' => $sdmteknic]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nama_tenaga_technic"
                                        value="{{ old('nama_tenaga_technic', $sdmteknic->nama_tenaga_technic) }}" required
                                ...
                                <div class="form-group col-md-4 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nip_jabatan_tenaga_technic"
                                        value="{{ old('nip_jabatan_tenaga_technic', $sdmteknic->nip_jabatan_tenaga_technic) }}"
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        name="jabatan_tenaga_technic"
                                        value="{{ old('jabatan_tenaga_technic', $sdmteknic->jabatan_tenaga_technic) }}"
                                        required autocomplete="name" placeholder="{{ __('Jabatan Tenaga Teknis') }}">
                                ...
                                <div class="form-group col-md-5 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nohp_tenaga_technic"
                                        value="{{ old('nohp_tenaga_technic', $sdmteknic->nohp_tenaga_technic) }}" required
                                ...
                                <div class="form-group col-md-5 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        name="email_tenaga_technic"
                                        value="{{ old('email_tenaga_technic', $sdmteknic->email_tenaga_technic) }}"
                                ...
                                <div class="form-group col-md-2 col-12">
                                    ...
                                    <select
                                        ...
                                        <option value="">-</option>
                                        <option
                                            value="pejabat"{{ old('status_tenaga_technic', $sdmteknic->status_tenaga_technic) == 'pejabat' ? 'selected' : '' }}>
                                            Pejabat</option>
                                        <option
                                            value="teknis"{{ old('status_tenaga_technic', $sdmteknic->status_tenaga_technic) == 'teknis' ? 'selected' : '' }}>
                                            Teknis
                                        </option>
                                    </select>
