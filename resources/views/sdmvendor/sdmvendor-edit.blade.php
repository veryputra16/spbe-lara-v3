                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="post" class="needs-validation" novalidate=""
                            action="{{ route('admin.sdmpengembang.update', ['application' => $application->id, 'sdmpengembang' => $sdmpengembang]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nama_pengembang', $sdmpengembang->nama_pengembang) }}" required
                                ...
                                <div id="alamat_pengembang" class="form-group col-md-8 col-12">
                                    ...
                                    <textarea class="form-control @error('alamat_pengembang') is-invalid @enderror" name="alamat_pengembang"
                                        ...
                                        style="height: 100px;">{{ old('alamat_pengembang', $sdmpengembang->alamat_pengembang) }}</textarea>
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nohp_pengembang', $sdmpengembang->nohp_pengembang) }}" required
                                ...
                                <div class="form-group col-md-5 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nokantor_pengembang', $sdmpengembang->nokantor_pengembang) }}"
                                ...
                                <div class="form-group col-md-5 col-12">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('email_pengembang', $sdmpengembang->email_pengembang) }}"
