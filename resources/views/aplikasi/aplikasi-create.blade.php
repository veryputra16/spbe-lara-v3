                        ...
                        <form method="post" class="needs-validation" novalidate=""
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-2 col-12">
                                    ...
                                    {{-- Tahun Pembuatan --}}
                                    <select id="tahun_buat" class="form-control select2 @error('tahun_buat') is-invalid @enderror"
                                        name="tahun_buat" required autocomplete="tahun_buat">
                                        <option>-</option>
                                        @for ($i = date('Y'); $i >= 2005; $i--)
                                            <option value="{{ $i }}" {{ old('tahun_buat') == $i ? 'selected' : '' }}>{{ $i }}</option>
                                        @endfor
                                    </select>
                                    @error('tahun_buat')
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <br>
                                    ...
                                    <hr>
                                <div class="card-body">
                                    <input type="hidden" name="user_id" value="{{ old('user_id', auth()->user()->id) }}" required readonly>
                                    
                                    <div class="form-group col-md-2 col-12">
                                        <label>{{ __('Tahun Pengembangan') }}</label>
                                        {{-- Tahun Pengembangan --}}
                                        <select id="tahun_pengembangan" class="form-control select2 @error('tahun_pengembangan') is-invalid @enderror"
                                            name="tahun_pengembangan" required autocomplete="tahun_pengembangan">
                                            <option>-</option>
                                            @for ($i = date('Y'); $i >= 2005; $i--)
                                                <option value="{{ $i }}" {{ old('tahun_pengembangan') == $i ? 'selected' : '' }}>{{ $i }}</option>
                                            @endfor
                                        </select>
