        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <table class="table table-borderless table-sm w-100">
                    <tr>
                        <td style="width: 220px; white-space: nowrap;"><strong>Nama Aplikasi</strong></td>
            ...
            <div class="col-md-6">
                <table class="table table-borderless table-sm w-100">
                    <tr>
                        <td style="width: 220px; white-space: nowrap;"><strong>Video Penggunaan</strong></td>
                        <td class="text-muted">:</td>
                        <td>
                            @if ($pengembangan->video_penggunaan)
                                <a href="{{ $pengembangan->video_penggunaan }}" target="_blank">Lihat Video</a>
                            @else
                                <span class="text-muted">-</span>
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($pengembangan->nda)
                                <a href="{{ asset('storage/' . $pengembangan->nda) }}" target="_blank">Lihat Dokumen NDA</a>
                            @else
                                <span class="text-muted">-</span>
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($pengembangan->surat_mohon)
                                <a href="{{ asset('storage/' . $pengembangan->surat_mohon) }}" target="_blank">Lihat Surat</a>
                            @else
                                <span class="text-muted">-</span>
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($pengembangan->kak)
                                <a href="{{ asset('storage/' . $pengembangan->kak) }}" target="_blank">Lihat KAK</a>
                            @else
                                <span class="text-muted">-</span>
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($pengembangan->sop)
                                <a href="{{ asset('storage/' . $pengembangan->sop) }}" target="_blank">Lihat SOP</a>
                            @else
                                <span class="text-muted">-</span>
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($pengembangan->doc_pentest)
                                <a href="{{ asset('storage/' . $pengembangan->doc_pentest) }}" target="_blank">Lihat Pentest</a>
                            @else
                                <span class="text-muted">-</span>
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($pengembangan->doc_uat)
                                <a href="{{ asset('storage/' . $pengembangan->doc_uat) }}" target="_blank">Lihat UAT</a>
                            @else
                                <span class="text-muted">-</span>
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($pengembangan->buku_manual)
                                <a href="{{ asset('storage/' . $pengembangan->buku_manual) }}" target="_blank">Lihat Buku</a>
                            @else
                                <span class="text-muted">-</span>
                            @endif
                        </td>
