                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="post" class="needs-validation" novalidate=""
                            action="{{ route('admin.interop.update', ['application' => $application->id, 'interop' => $interop]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    @if ($interop->doc_interop != '')
                                        <div class="mb-0 d-block">
                                            <a href="{{ asset(Storage::url($interop->doc_interop)) }}" target="_blank">
                                ...
                                <div id="ket_interop" class="form-group col-md-8 col-12">
                                    ...
                                    <textarea class="form-control @error('ket_interop') is-invalid @enderror" name="ket_interop" id="ket_interop"
                                        autocomplete="ket_interop" placeholder="{{ __('Alamat Vendor') }}" style="height: 200px;">{{ old('ket_interop', $interop->ket_interop) }}</textarea>
                                    @error('ket_interop')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
