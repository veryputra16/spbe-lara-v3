                    ...
                    <div class="card">
                        <form method="post" class="needs-validation" novalidate=""
                            ...
                            <div class="card-body">
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <input type="text" class="form-control @error('caption') is-invalid @enderror"
                                        name="caption" value="{{ old('caption', $faq->caption) }}" autocomplete="caption"
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <textarea class="form-control @error('desc') is-invalid @enderror" name="desc" autocomplete="desc"
                                        placeholder="{{ __('Deskripsi') }}" style="height: 150px;resize: vertical">{{ old('desc', $faq->desc) }}</textarea>
                                    @error('desc')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="card-footer text-left">
                                <a href="{{ route('admin.faq.index') }}" class="btn btn-dark">{{ __('Back') }}</a>
