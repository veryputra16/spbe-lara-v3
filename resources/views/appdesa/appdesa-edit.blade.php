                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="post" class="needs-validation" novalidate=""
                            action="{{ route('admin.appdesa.update', $appdesa) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <input type="text" class="form-control @error('nama_app') is-invalid @enderror"
                                        name="nama_app" value="{{ old('nama_app', $appdesa->nama_app) }}" required
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <textarea class="form-control @error('fungsi_app') is-invalid @enderror" name="fungsi_app" required
                                        autocomplete="fungsi_app" placeholder="{{ __('Fungsi Aplikasi') }}" style="height: 200px;resize: vertical">{{ old('fungsi_app', $appdesa->fungsi_app) }}</textarea>
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <input type="text" class="form-control @error('url') is-invalid @enderror"
                                        name="url" value="{{ old('url', $appdesa->url) }}" autocomplete="url"
                                        placeholder="{{ __('Url') }}">
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    <input type="text" class="form-control @error('repositori') is-invalid @enderror"
                                        name="repositori" value="{{ old('repositori', $appdesa->repositori) }}"
                                    ...
                                    <select class="form-control select2 @error('layananapp_id') is-invalid @enderror"
                                        ...
                                        @forelse ($layananapps as $layananapp)
                                            <option value="{{ $layananapp->id }}"
                                                {{ $appdesa->layananapp_id == $layananapp->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-md-2 col-12">
                                    ...
                                    <select class="form-control select2 @error('jaringan_intra') is-invalid @enderror"
                                        ...
                                        <option value="1" {{ $appdesa->jaringan_intra == '1' ? 'selected' : '' }}>
                                            Internet</option>
                                        <option value="2" {{ $appdesa->jaringan_intra == '2' ? 'selected' : '' }}>
                                            Intranet</option>
                                    </select>
                                ...
                                <div class="form-group col-md-2 col-12">
                                    ...
                                    <select class="form-control select2 @error('status') is-invalid @enderror"
                                        ...
                                        {{-- <option value="">-</option> --}}
                                        <option value="1"{{ $appdesa->status == '1' ? 'selected' : '' }}>Aktif
                                        </option>
                                        <option value="0"{{ $appdesa->status == '0' ? 'selected' : '' }}>Tidak
                                            Aktif
                                        </option>
                                    </select>
                                    @error('status')
                                ...
                                <div id="alasan_non_aktif" class="form-group col-md-8 col-12" style="display: none">
                                    ...
                                    <textarea class="form-control @error('alasan_nonaktif') is-invalid @enderror" name="alasan_nonaktif"
                                        ...
                                        style="height: 200px;resize: vertical">{{ old('alasan_nonaktif', $appdesa->alasan_nonaktif) }}</textarea>
                                    ...
                                    <select class="form-control select2 @error('katpengguna_id') is-invalid @enderror"
                                        ...
                                        @forelse ($katpenggunas as $katpengguna)
                                            <option value="{{ $katpengguna->id }}"
                                                {{ $appdesa->katpengguna_id == $katpengguna->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control select2 @error('katserver_id') is-invalid @enderror"
                                        ...
                                        @forelse ($katservers as $katserver)
                                            <option value="{{ $katserver->id }}"
                                                {{ $appdesa->katserver_id == $katserver->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control select2 @error('katapp_id') is-invalid @enderror"
                                        ...
                                        @forelse ($katapps as $katapp)
                                            <option value="{{ $katapp->id }}"
                                                {{ $appdesa->katapp_id == $katapp->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-md-8 col-12">
                                    ...
                                    @if ($appdesa->dasar_hukum != '')
                                        <div class="mb-0 d-block">
                                            <a href="{{ asset(Storage::url($appdesa->dasar_hukum)) }}" target="_blank">
                                ...
                                <div class="form-group col-md-2 col-12">
                                    ...
                                    <select class="form-control select2 @error('aset_takberwujud') is-invalid @enderror"
                                        ...
                                        <option value="">-</option>
                                        <option value="0" {{ $appdesa->aset_takberwujud == '0' ? 'selected' : '' }}>
                                            Tidak</option>
                                        <option value="1" {{ $appdesa->aset_takberwujud == '1' ? 'selected' : '' }}>
                                            Ya
                                        </option>
                                    </select>
                            ...
                            <div class="card-footer text-left">
                                <a href="{{ route('admin.appdesa.index') }}""
