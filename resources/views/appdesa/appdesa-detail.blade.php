                                    ...
                                    <div><span><i class="fas fa-th"></i>
                                        ...
                                        &bull; <span><i class="fas fa-link"></i>
                                            @empty($appdesa->url)
                                                {{ 'Url Tidak Ada' }}
                                            @else
                                                <a href="{{ $appdesa->url }}" target="_blank">{{ $appdesa->url }}</a>
                                            @endempty
                                        </span>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-hover table-sm" id="">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="w-75">
                                                            {{ $appdesa->fungsi_app ? $appdesa->fungsi_app : '-' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="w-75">
                                                            @empty($appdesa->dasar_hukum)
                                                                <span class="btn btn-danger btn btn-sm">Dasar Hukum Tidak
                                                                    Ada</span>
                                                            @else
                                                                <a href="{{ asset(Storage::url($appdesa->dasar_hukum)) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="w-75">
                                                            {{ $appdesa->tahun_buat ? $appdesa->tahun_buat : '-' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="w-75">
                                                            @empty($appdesa->repositori)
                                                                <span class="btn btn-danger btn btn-sm">Repositori Tidak
                                                                    Ada</span>
                                                            @else
                                                                <a href="{{ $appdesa->repositori }}"
                                                                    target="_blank">{{ $appdesa->repositori }}</a>
                                                            @endempty
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="w-75"><span class="btn btn-sm btn-light">
                                                                {{ $appdesa->katpengguna->kategori_pengguna }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="w-75"><span class="btn btn-sm btn-light">
                                                                {{ $appdesa->layananapp->layanan_app }}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="w-25">Aset Tak Berwujud</th>
                                                        <td>:</td>
                                                        <td class="w-75">
                                                            @if ($appdesa->aset_takberwujud == 1)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="w-75">
                                                            @if ($appdesa->jaringan_intra == 1)
                                                                <span class="btn btn-sm btn-light">Internet</span>
                                                            @endif
                                                            @if ($appdesa->jaringan_intra == 2)
                                                    ...
                                                    @if ($appdesa->status == 0)
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td class="w-75">{{ $appdesa->alasan_nonaktif }}</td>
                                                        </tr>
                                                    @endif
                                                    <tr>
                                                        ...
                                                        <td class="w-75">
                                                            <span class="btn btn-sm btn-outline-dark">
                                                                {{ $appdesa->updated_at->translatedFormat('d F Y') }}
                                                                oleh
                                                                {{ $appdesa->user->name }}</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
